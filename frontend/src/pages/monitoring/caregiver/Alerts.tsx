...
export function CaregiverMonitoringAlerts(): React.ReactElement {
              ...
              <div className="flex items-start justify-between">
                ...
                {!alert.acknowledged_at && !alert.resolved && (
                  <button
                    ...
                    className="px-3 py-1.5 text-xs rounded-lg bg-primary-600 hover:bg-primary-500 text-white flex-shrink-0 ml-3"
                  >
                    Acknowledge
                  </button>
                )}
