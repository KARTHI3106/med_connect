...
export function CaregiverMonitoringPatients(): React.ReactElement {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-white">Patients Under Care</h1>
      ...
      {loading ? (
        ...
        <GlassCard className="text-center py-12">
          ...
          <p className="text-white/50">No patients assigned.</p>
        </GlassCard>
      ) : (
