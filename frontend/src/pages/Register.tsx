...
export function Register() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (success) {
      ...
      setError(
        "Registration failed. Phone or Aadhaar may already be registered.",
      );
    }
  };
          ...
          <GlassCard className="p-8">
            <div className="text-center mb-8">
              <img
                src="/logo.jpg"
                alt="MedConnect"
                className="w-16 h-16 rounded-2xl mx-auto mb-4 shadow-lg shadow-primary-500/20 object-contain"
              />
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <option value="pharmacy" className="bg-slate-900">
                          Pharmacy
                        </option>
